...
// For now, track conversions (between app.Track and domain.Track) happen directly in mainapp.go
...
// Instead, these conversions are handled in mainapp.go where the full type information is available.
