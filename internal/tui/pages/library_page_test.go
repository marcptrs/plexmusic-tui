...
// Note: TestLibraryPage_TrackSelectionUpdatesCoverArt and TestLibraryPage_RecentlyAddedSelectionUpdatesCoverArt
// were removed because browsing-initiated cover art fetches have been disabled to prevent
// them from interfering with the currently playing track's art. Cover art is now only
// updated when playback.started event fires with a new track.
